...
<br> Marco Mendez: <br> Mi enfoque fue mantener una comunicación constante para resolver dudas y, de forma particular, facilitar la integración de los avances técnicos del backend, apoyando la resolución de desafíos específicos en su desarrollo y asegurando la claridad de su documentación
